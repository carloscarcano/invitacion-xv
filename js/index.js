...
function obtenerInvitado()
{
    ...
    switch(invitado) 
    {
        ...
        case '72': nombre.html('Yeni Cabrera '); personas.html('2 Personas'); break;
        case '73': nombre.html('Yoli Cernuda'); personas.html('2 Personas'); break;
        case '74': nombre.html('Yari Cabrera'); personas.html('2 Personas'); break;
